...
- Define the Horizon T by deciding on the N and dt. [N=10, dt=0.02].
   ...
   - Tunning process:
      ...
      - T = 1 : N=50, dt=0.02. It did come up with a very low cost value. But it is computational too expensive. What it means is controller is slow to respond. The car drives off the road.
